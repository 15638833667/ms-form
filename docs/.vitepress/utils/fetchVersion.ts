/*
  ...
  return fetch('https://api.github.com/repos/themusecatcher/ms-form/contents/package.json?ref=master', {
    headers: {
  ...
  return fetch('https://raw.githubusercontent.com/themusecatcher/ms-form/master/package.json')
*/

/*
  ...
  return fetch('https://api.github.com/repos/themusecatcher/ms-form-js/contents/package.json?ref=master', {
    headers: {
  ...
  return fetch('https://raw.githubusercontent.com/themusecatcher/ms-form-js/master/package.json')
*/
